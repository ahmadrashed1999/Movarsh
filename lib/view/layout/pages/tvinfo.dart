...
import 'package:movarsh/constant/methods/methoods.dart';
...
class TvInfo extends StatefulWidget {
  ...
  final List links;
  final List images;
  final List similarTv;
  TvInfo(
      {Key? key,
      required this.tvModel,
      required this.similarTv,
      required this.links,
...
class _TvInfoState extends State<TvInfo> {
  ...
  void initState() {
    ...
    // or the internet
    isVaf = favController.getidfavTv(widget.tvModel.id!);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.tvModel.name!),
        actions: [
          IconButton(
            icon: !isVaf
            ...
            onPressed: () {
              print('ssssss');
              if (isVaf) {
                favController.removefavTV(widget.tvModel.id!);
                ...
                favController.addtoFavTv(widget.tvModel);
                setState(() {
                  isVaf = true;
                });
                print(favController.getFav[0].id.toString());
        ...
        child: SingleChildScrollView(
          child:
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Container(
                      child:
                          Text(widget.tvModel.name!, style: subHeadingStyle)),
                  Spacer(),
                  Column(
                    children: [
                      Text(widget.tvModel.firstAirDate!,
                          style: subHeadingStyle2),
                      RatingBar.builder(
                        tapOnlyMode: true,
                        initialRating: widget.tvModel.voteAverage! / 2,
                        itemSize: 12,
                        minRating: 1,
            ...
            Container(
                ...
                child: Text(widget.tvModel.tagline!, style: subHeadingStyle)),
            Padding(
              padding: const EdgeInsets.all(30.0),
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  Text(widget.tvModel.overview!, style: subHeadingStyle2),
                ],
              ),
            ),
            Padding(
                ...
                children: [
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: ((context, index) {
                        return Container(
                          ...
                          child: Text(
                            widget.tvModel.genres![index].name.toString() + " ",
                            style: subHeadingStyle2,
                            softWrap: true,
                          ),
                        );
                      }),
                      itemCount: widget.tvModel.genres!.length,
                    ),
                  ),
                  Container(
                  ...
                  Container(
                    ...
                    child: ListView.separated(
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            Container(
                              width: 170,
                              child: Text(
                                widget.tvModel.seasons![index].name.toString(),
                            ...
                            Container(
                              ...
                              child: Text(
                                'Episodes Number :' +
                                    widget.tvModel.seasons![index].episodeCount
                                        .toString(),
                                style: subHeadingStyle2.copyWith(),
                                softWrap: true,
                              ),
                      ...
                      itemCount: widget.tvModel.seasons!.length,
                    ),
                  ),
                  Container(
                    margin: EdgeInsets.symmetric(vertical: 20),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                width: 170,
                                child: Text(
                                  widget.similarTv[index]['name'].toString(),
                                  style: subHeadingStyle2.copyWith(),
                                  softWrap: true,
                                ),
                              ),
                              RatingBar.builder(
                                tapOnlyMode: true,
                                initialRating:
                                    widget.similarTv[index]['vote_average'] / 2,
                                itemSize: 12,
                                minRating: 1,
                                direction: Axis.horizontal,
                                allowHalfRating: true,
